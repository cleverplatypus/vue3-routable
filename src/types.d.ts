...
export type ParamMetadataType = typeof TO_METADATA | typeof PARAM_METADATA | typeof QUERY_METADATA | typeof META_METADATA | typeof FROM_METADATA | typeof THIS_HANDLER_METADATA;
/**
 * @ignore
 */
...
export type RouteChangeHandler = (target: any, to?: RouteLocation, from?: RouteLocation) => Promise<boolean | RouteRecordRaw>;
/**
...
export type MetaDecoratorArgs = string | RequireAtLeastOneParameter<{
    path?: string;
    route?: 'from' | 'to';
}>;
export {};
